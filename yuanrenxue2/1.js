...
function get_encrypt(){
    return out_i.toString()
}

function get_data(t) {
            var r = Date['now'](),
            n = "666yuanrenxue66",
            o = out_i.AES.encrypt(r + String(t), n, {
                mode: out_i.mode.ECB,
                padding: out_i.pad.Pkcs7
            })
             c = "/api/match2023/1", a = {
                page: String(t),
                token: out_i.MD5(o.toString()).toString(),
                now: r
            };
            // console.log(out_i.MD5(o.toString()).toString())
            // console.log("f49fb835ae76de6bb35981a5b0c6d37d")
    return a
}
get_data(1)
