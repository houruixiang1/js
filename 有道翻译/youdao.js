...
function ss(e) {
    var t = md55("5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/106.0.0.0 Safari/537.36");
    var r = "" + (new Date).getTime();
    var it = r + parseInt(10 * Math.random(), 10);
    return {
        ts: r,
        bv: t,
        salt: it,
        sign: md55("fanyideskweb" + e + it + "Ygy_4c=r#e#4EX^NUGUc5")
    }
}